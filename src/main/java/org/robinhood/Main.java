...
public class Main {
    public static void main(String[] args) throws AWTException, IOException {
        final BufferedImage tgt = ImageIO.read(new File("/Users/pavel/Desktop/trgt.png"));
        final BufferedImage src = ImageIO.read(new File("/Users/pavel/Desktop/trc.png"));
        final int[] subimage = findSubimage(tgt, src);

        System.out.println(subimage.length);
    }
